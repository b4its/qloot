...
<div class="flex flex-wrap items-end justify-between gap-4">
  <div>
    <h1 class="text-2xl font-bold">Counselling Room (BK)</h1>
    <p class="mt-1 text-sm muted">Book sessions and track their status (simulated).</p>
  </div>
...
<div class="mt-4 grid gap-4 lg:grid-cols-3">
  <div class="card lg:col-span-2">
    <h2 class="font-semibold">Your sessions</h2>
    {#if loading}
  ...
  <div class="card h-fit">
    ...
    <div class="mt-4 border-t pt-3">
      <p class="text-xs font-mono uppercase muted">Counsellors</p>
